...
mysqli_select_db( $link, $dbname )
or die("Could not open the db '$dbname'"); 
$test_query = "select * from inventory where item_name LIKE '%".$_POST['search']."%' OR item_description LIKE '%".$_POST['search']."%'";
$result = mysqli_query( $link, $test_query);

echo '<form action="index.php"><input type="submit" class="btn" value="<------ Return to Homepage"></form>';
echo '<table border="2">';
