...
<!-- Added PHP code for the purchases made on the page -->
...
mysqli_select_db( $link, $dbname )
or die("Could not open the db '$dbname'"); 
$test_query = "select * from inventory where item_group=1001 limit 6";
...
while( $row = mysqli_fetch_array( $result, MYSQLI_ASSOC ) )
{
 ...
 if ($row[ 'item_image_loc' ] == "aa01-001.jpg") {
    echo '<td>', '<img src="images\aa01-001.jpg" height = "59px"/>', '</td>';
 }
 if ($row[ 'item_image_loc' ] == "aa01-002.jpg") {
    echo '<td>', '<img src="images\aa01-002.jpg" height = "59px"/>', '</td>';
 }
 if ($row[ 'item_image_loc' ] == "aa01-003.jpg") {
    echo '<td>', '<img src="images\aa01-003.jpg" height = "59px"/>', '</td>';
 }
 if ($row[ 'item_image_loc' ] == "aa01-004.jpg") {
    echo '<td>', '<img src="images\aa01-004.jpg" height = "59px"/>', '</td>';
 }
 if ($row[ 'item_image_loc' ] == "aa01-005.jpg") {
    echo '<td>', '<img src="images\aa01-005.jpg" height = "59px"/>', '</td>';
 }
 if ($row[ 'item_image_loc' ] == "aa01-006.jpg") {
    echo '<td>', '<img src="images\aa01-006.jpg" height = "59px"/>', '</td>';
 }
 echo
 '<td>', $row[ 'item_name' ], '</td>',
