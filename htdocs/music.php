...
mysqli_select_db( $link, $dbname )
or die("Could not open the db '$dbname'"); 
$test_query = "select * from inventory where item_group=1002 limit 6";
...
while( $row = mysqli_fetch_array( $result, MYSQLI_ASSOC ) )
{
 ...
 if ($row[ 'item_image_loc' ] == "aa01-007.jpg") {
    echo '<td>', '<img src="images\aa01-007.jpg" height = "59px"/>', '</td>';
 }
 if ($row[ 'item_image_loc' ] == "aa01-008.jpg") {
    echo '<td>', '<img src="images\aa01-008.jpg" height = "59px"/>', '</td>';
 }
 if ($row[ 'item_image_loc' ] == "aa01-009.jpg") {
    echo '<td>', '<img src="images\aa01-009.jpg" height = "59px"/>', '</td>';
 }
 if ($row[ 'item_image_loc' ] == "aa01-010.jpg") {
    echo '<td>', '<img src="images\aa01-010.jpg" height = "59px"/>', '</td>';
 }
 if ($row[ 'item_image_loc' ] == "aa01-011.jpg") {
    echo '<td>', '<img src="images\aa01-011.jpg" height = "59px"/>', '</td>';
 }
 if ($row[ 'item_image_loc' ] == "aa01-012.jpg") {
    echo '<td>', '<img src="images\aa01-012.jpg" height = "59px"/>', '</td>';
 }
 echo
 '<td>', $row[ 'item_name' ], '</td>',
